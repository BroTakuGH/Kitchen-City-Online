...
public final class ActivityMain4Binding implements ViewBinding {
  ...
  private ActivityMain4Binding(@NonNull ConstraintLayout rootView, @NonNull Button button,
      @NonNull Button button2, @NonNull TextInputEditText editText,
      @NonNull TextInputEditText editText2, @NonNull ImageView imageView) {
  ...
  public static ActivityMain4Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.editText2;
      TextInputEditText editText2 = ViewBindings.findChildViewById(rootView, id);
      if (editText2 == null) {
        break missingId;
      }
      ...
      return new ActivityMain4Binding((ConstraintLayout) rootView, button, button2, editText,
          editText2, imageView);
    }
