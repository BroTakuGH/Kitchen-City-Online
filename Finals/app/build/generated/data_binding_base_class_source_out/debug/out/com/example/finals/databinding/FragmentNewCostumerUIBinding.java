...
public final class FragmentNewCostumerUIBinding implements ViewBinding {
  ...
  private FragmentNewCostumerUIBinding(@NonNull FrameLayout rootView,
      ...
      @NonNull TextView thirdCaption, @NonNull ImageView thirdMenu, @NonNull TextView thirdPrice) {
  ...
  public static FragmentNewCostumerUIBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentNewCostumerUIBinding((FrameLayout) rootView, fifthCaption, fifthMenu,
          ...
          secondCaption, secondMenu, secondPrice, sixthCaption, sixthMenu, sixthPrice, thirdCaption,
