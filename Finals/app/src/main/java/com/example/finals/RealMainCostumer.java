...
import com.example.finals.databinding.ActivityRealMainCostumerBinding;
...
public class RealMainCostumer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_real_main_costumer);
        //Declaration
        ...
        nav.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()){
                    ...
                    case R.id.nav_cart:
                        Intent intent=new Intent(RealMainCostumer.this,cart.class);
                        startActivity(intent);
                        break;

                    case R.id.nav_logout:
                        Intent intent2=new Intent(RealMainCostumer.this,MainActivity2.class);
        ...
        databaseReference.child("Images").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Glide.with(RealMainCostumer.this).load(imageURLDisplay1).into(firstMenu);
                Glide.with(RealMainCostumer.this).load(imageURLDisplay2).into(secondMenu);
                Glide.with(RealMainCostumer.this).load(imageURLDisplay3).into(thirdMenu);
                Glide.with(RealMainCostumer.this).load(imageURLDisplay4).into(fourthMenu);
                Glide.with(RealMainCostumer.this).load(imageURLDisplay5).into(fifthMenu);
                Glide.with(RealMainCostumer.this).load(imageURLDisplay6).into(sixthMenu);
            ...
            public void onClick(View view){
                ...
                databaseReference.child("Images").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Intent intent=new Intent(com.example.finals.RealMainCostumer.this,order.class);
